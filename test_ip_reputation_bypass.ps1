# Test IP Reputation Bypass
# Temporarily disable IP reputation API to isolate the issue
...
# Temporarily clear IP reputation API key
$originalIPRepKey = $env:IP_REPUTATION_API_KEY
$env:IP_REPUTATION_API_KEY = ""

Write-Info "Temporarily disabled IP reputation API key"
