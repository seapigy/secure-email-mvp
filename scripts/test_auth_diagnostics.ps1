...
function Test-HashConsistency {
    ...
    Write-Host " Testing Hash Consistency" -ForegroundColor Cyan
    Write-Host "=" * 80 -ForegroundColor Cyan
...
function Test-TOTPValidation {
    Write-Host ""
    Write-Host "=" * 80 -ForegroundColor Cyan
    Write-Host " Testing TOTP Validation" -ForegroundColor Cyan
    Write-Host "=" * 80 -ForegroundColor Cyan
...
function Test-ExistingUserAuthentication {
    Write-Host ""
    Write-Host "=" * 80 -ForegroundColor Cyan
    Write-Host " Testing Existing User Authentication" -ForegroundColor Cyan
    Write-Host "=" * 80 -ForegroundColor Cyan
...
function Start-AuthDiagnostics {
    Write-Host ""
    Write-Host "Starting Authentication Diagnostics" -ForegroundColor Yellow
    Write-Host "Base URL: $($TestConfig.BaseUrl)" -ForegroundColor Gray
    Write-Host "Test Email: $($TestConfig.TestEmail)" -ForegroundColor Gray
    Write-Host "Test TOTP Secret: $($TestConfig.TestTOTPSecret)" -ForegroundColor Gray
    ...
    Write-Host " Authentication Diagnostics Complete" -ForegroundColor Green
    Write-Host "=" * 80 -ForegroundColor Green
    
    Write-Host ""
    Write-Host "Next Steps:" -ForegroundColor White
    Write-Host "  1. Check server logs for [AUTH_DEBUG] messages" -ForegroundColor Yellow
    Write-Host "  2. Compare hash generation between signup and login" -ForegroundColor Yellow
    Write-Host "  3. Verify TOTP secret encoding and validation" -ForegroundColor Yellow
    Write-Host "  4. Check for email normalization differences" -ForegroundColor Yellow
}
