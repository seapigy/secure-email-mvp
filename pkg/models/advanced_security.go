...
// SystemSecurityPolicy represents system-wide security policies
type SystemSecurityPolicy struct {
	PolicyID          string    `json:"policy_id" db:"policy_id"`
	PolicyName        string    `json:"policy_name" db:"policy_name"`
	PolicyDescription *string   `json:"policy_description,omitempty" db:"policy_description"`
	PolicyType        string    `json:"policy_type" db:"policy_type"` // 'password', 'mfa', 'session', 'retention', 'dlp', 'general'
	IsActive          bool      `json:"is_active" db:"is_active"`
	PolicyValue       string    `json:"policy_value" db:"policy_value"`           // JSON string for complex policies
	PolicyCategory    string    `json:"policy_category" db:"policy_category"`     // 'authentication', 'authorization', 'data_protection', 'compliance'
	Severity          string    `json:"severity" db:"severity"`                   // 'low', 'medium', 'high', 'critical'
	EnforcementLevel  string    `json:"enforcement_level" db:"enforcement_level"` // 'recommended', 'required', 'mandatory'
	CreatedAt         time.Time `json:"created_at" db:"created_at"`
	UpdatedAt         time.Time `json:"updated_at" db:"updated_at"`
	CreatedBy         *string   `json:"created_by,omitempty" db:"created_by"`
...
// SystemSecurityPolicyUpdateRequest represents a request to update system security policies
type SystemSecurityPolicyUpdateRequest struct {
...
// SystemSecurityPolicyResponse represents a response with system security policies
type SystemSecurityPolicyResponse struct {
	Success   bool                   `json:"success"`
	Policies  []SystemSecurityPolicy `json:"policies,omitempty"`
