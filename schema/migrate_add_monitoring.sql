...
-- Migration: Add monitoring_events table for system metrics and event tracking
...
CREATE TABLE IF NOT EXISTS monitoring_events (
    ...
    source VARCHAR(100), -- service name (dlp, watermarking, api, etc.)
    user_id VARCHAR(100),
...
INSERT OR IGNORE INTO system_config (config_key, config_value, description, created_at) VALUES
('monitoring.retention_days', '30', 'Number of days to retain monitoring events', CURRENT_TIMESTAMP),
('monitoring.enabled', 'true', 'Enable real-time monitoring', CURRENT_TIMESTAMP),
('monitoring.sample_rate', '1.0', 'Event sampling rate (0.0-1.0)', CURRENT_TIMESTAMP),
('monitoring.alert_threshold_error_rate', '0.05', 'Error rate threshold for alerts (5%)', CURRENT_TIMESTAMP),
('monitoring.alert_threshold_latency_ms', '1000', 'Latency threshold for alerts (1 second)', CURRENT_TIMESTAMP);
